  ...
  return (
    <section className='relative bg-black h-screen py-20 text-center'>
      ...
      <div className='my-16 [perspective:800px] [transform-style:preserve-3d]'>
        <div className="flex flex-col gap-4  bg-[rgb(39,42,46)]  transition mx-auto h-48 w-48 my-5 overflow-hidden " style={{ transform: "rotateX(60deg) rotate(-45deg)" }}  onMouseEnter={() => console.log("enter")} onMouseLeave={()=>console.log("leave")}>
          <div className=' flex w-full h-1'>
            <div className='bg-[rgb(243,100,88)] w-3 h-3'></div>
            <div className='bg-[rgb(26,28,31)] w-full h-3'></div>
          </div>
          <div className='flex gap-2 h-full p-[10px] '>
            <div className=' flex flex-col gap-1 w-1/5  bg-[rgb(63,67,74)]'>
              <div className='w-full h-[6px] bg-[rgb(86,93,103)] '></div>
              <div className='w-full h-[6px] bg-[rgb(86,93,103)] '></div>
              <div className='w-full h-[6px] bg-[rgb(86,93,103)] '></div>
              <div className='w-full h-[6px] bg-[rgb(86,93,103)] '></div>
              <div className='w-full h-[6px] bg-[rgb(86,93,103)] '></div>
              <div className='w-full h-[6px] bg-[rgb(86,93,103)] '></div>
              <div className='w-[70%] h-[6px] bg-[rgb(86,93,103)] '></div>
            </div>
            <div className='flex flex-col gap-1 w-4/5 bg-[rgb(63,67,74)] '>
              <div className='w-full h-[6px] bg-[rgb(86,93,103)] '></div>
              <div className='w-full h-[6px] bg-[rgb(86,93,103)] '></div>
              <div className='w-full h-[6px] bg-[rgb(86,93,103)] '></div>
              <div className='w-[70%] h-[6px] bg-[rgb(86,93,103)] '></div>
              <div className='w-full h-[40px] bg-[rgb(86,93,103)] '></div>
              <div className='w-full h-[6px] bg-[rgb(86,93,103)] '></div>
              <div className='w-[86%] h-[6px] bg-[rgb(86,93,103)] '></div>
              <div className='w-full h-[6px] bg-[rgb(86,93,103)] '></div>
            </div>
          </div>
        </div>
